package top.alanpu.sparklenote.app.ui.screens.backup
...
import top.alanpu.sparklenote.app.utils.BackupCompatibilityProcessor
import top.alanpu.sparklenote.app.utils.BackupFileImporter
import top.alanpu.sparklenote.app.utils.BackupManager
import top.alanpu.sparklenote.app.utils.BackupPreview
import top.alanpu.sparklenote.app.utils.DataValidationUtil
import top.alanpu.sparklenote.app.utils.EnhancedBackupManager
...
class BackupManagementViewModel @Inject constructor(
    ...
    private var currentExternalBackupData: top.alanpu.sparklenote.app.utils.BackupData? = null
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                processedBackupData.themes?.forEach { themeBackup ->
                    try {
                        val theme = top.alanpu.sparklenote.app.domain.model.Theme(
            ...
            val allAvailableThemes = importedThemes + existingThemes
                ...
                processedBackupData.inspirations?.forEach { inspirationBackup ->
                    try {
                        ...
                        val inspiration = top.alanpu.sparklenote.app.domain.model.Inspiration(
